...
```bash
git clone https://github.com/Adalink-ai/koder-cli.git # Or your fork's URL
cd gemini-cli
```
...
- Consult [GEMINI.md](https://github.com/Adalink-ai/koder-cli/blob/main/GEMINI.md) (typically found in the project root) for specific instructions related to AI-assisted development, including conventions for React, comments, and Git usage.
